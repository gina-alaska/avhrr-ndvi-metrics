pro clavrone, c, d, jday, snow, site, flag

;
; does CLAVR (CLouds from AVhRr) - THIS VERSION DOES 100x100 PARTS
;					OF LAC IMAGES (I.E. ONE
;					  OF THE SITES...)
;
;
; INPUTS:
;
; c is standard 100x100x{10 or 12} input.  See readone.pro
