...
;  
;jz, 2012/3/5, modify from GetEOS_ver16.pro, get rid of guarrantee the sos point is good point 

FUNCTION  GetEOS_ver17, Cross, NDVI, bq, x,bpy,SOS,bma
...
;-------geteos_ver16.pro uses following condition         
...
;-------geteos_ver17.pro uses following condition  
       
         if ( v EQ 0 and possibx-1 GE 0) $
         or ( v NE 0 and fix(possibx)+1 LE lastidx) then begin ;found EOS <4> 
