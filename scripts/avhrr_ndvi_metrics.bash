...
avhrr_home_dir=/home/jiang/nps/cesu/avhrr_ndvi

#avhrr_data_dir=$where_avhrr_ndvi_data_is (ak_nd_1982,ak_nd_1982_sm)
avhrr_data_dir=/mnt/jzhu_scratch/nps-cesu/avhrr
...
export IDL_STARTUP=/home/jiang/nps/cesu/avhrr_ndvi/startup_nps

# 3. run idl program

/usr/local/bin/idl <<EOF
restore, filename='$avhrr_prog_dir/avhrr-ndvi-metrics.sav'
