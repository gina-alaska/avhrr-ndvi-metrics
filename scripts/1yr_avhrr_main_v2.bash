...
cp $rawdata_dir/$year/${year}_stacked_* $  $work_dir/$year
...
$script_dir/1yr_avhrr_calmetrics.bash $work_dir/$year/${year}_stacked_ndvi $work_dir/$year/${year}_stacked_bq $work_dir/$year/${year}_stacked_cldm 'ver7n'
...
cp $work_dir/${year}/* $result_dir/${year}
