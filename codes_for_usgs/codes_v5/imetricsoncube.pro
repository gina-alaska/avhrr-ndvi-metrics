PRO iMetricsOnCube, File, NS,NL,NB,ny, swl, ewl, bpy, DTYPE, ISS=ISS, ISL=ISL, $
...
; Write out Metrics
;
         SegWrite, SOST, File+'.sost', NS, NL, ss,sl,0
         SegWrite, SOSN, File+'.sosn', NS, NL, ss,sl,0
         SegWrite, EOST, File+'.eost', NS, NL, ss,sl,0
         SegWrite, EOSN, File+'.eosn', NS, NL, ss,sl,0
         SegWrite, MaxT, File+'.maxt', NS, NL, ss,sl,0
         SegWrite, MaxN, File+'.maxn', NS, NL, ss,sl,0
         SegWrite, RangeT, File+'.ranget', NS, NL, ss,sl,0
         SegWrite, RangeN, File+'.rangen', NS, NL, ss,sl,0
         SegWrite, TotalNDVI, File+'.totalndvi', NS, NL, ss,sl,0
         SegWrite, NDVIToDate, File+'.ndvitodate', NS, NL, ss,sl,0
         SegWrite, SlopeUp, File+'.slopeup', NS, NL, ss,sl,0
         SegWrite, SlopeDown, File+'.slopedn', NS, NL, ss,sl,0
