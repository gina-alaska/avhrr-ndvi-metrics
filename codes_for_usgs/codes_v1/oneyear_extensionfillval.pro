...
pro oneyear_extensionfillval,yearv,yearbq, yearbn,st_num,ed_num,days
...
compbn=strarr(st_num+numofyear+ed_num)
 ...
 compv[0:st_num-1]=80b
compbq[0:st_num-1]=20b  ; 20b--interpolate the begining and ending

 
 badidx=where(yearbq EQ 2b, badcnt)
...
compbq[st_num:st_num+numofyear-1]=yearbq
 ...
 compv[st_num+numofyear: st_num+numofyear+ed_num-1]=80b
