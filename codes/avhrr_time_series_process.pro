...
;---- calls interpol_extension_1y_vector_ver9.pro to process one-year data, do one-year vector extension, then inpterpolate
 ...
 avhrr_interpol_extension_1yr,tmp_ndvi,tmp_bq,tmp_cldm,tmp_bn,tmp_ndvi_interp,tmp_bq_interp, tmp_cldm_interp,tmp_bn_interp,stnum_real,ednum_real,flg_metrics
...
tmp_smooth1 =( tmp_smooth +a )*sfactor
 ...
 avhrr_user_metrics_by1yr, tmp_smooth1, tmp_interp1, tmp_bq, tmp_bn, metrics_cal_threshold,vmetrics ;vout--smoothed vector, vorg--orginal vector, vmetrics--metrics
