pro draw_plot_ndvi_forward_moving_average_threshold, var_sav_file
...
plt1=plot(x,ndvi,title='Determination of day of Start of Season (SOS)', 'r2',name='NDVI', xtitle='Index of 7-day composite', ytitle='NDVI scaled to [0, 1]')

symb1=symbol(starts.x[0],starts.y[0],'star',/DATA, sym_color='red',sym_size=2,label_string='crossover')

plt2=plot(x,fma,'b--2',/OVERPLOT,name='Fwd Moving Avg')

symb2=symbol(starts.x[1],starts.y[1],'triangle',/DATA, sym_color='red',sym_size=2,label_string='threshold')
