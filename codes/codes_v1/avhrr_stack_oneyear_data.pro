pro avhrr_stack_oneyear_data, flist_ndvi, flist_bq, flist_cldmask, ul_lon,ul_lat,lr_lon,lr_lat
...
;flistndvi =flist[where(flist NE '')]
;flistbq=flistbq[where(flistbq NE '')]
;flistcld=flistcld[where(flistcld NE '')]
...
tmpday= strmid(tmpfilename,9,6)   ;file name format is: n17_ak05_09612_ndvi.tif
