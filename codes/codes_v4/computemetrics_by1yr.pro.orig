...
SOS=GetSOS_ver18(Starts, NDVI,bq,Time, bpy, FMA)     ;find the possible sos among the crossovers which is the most close to 20% up threshold point, guarentee possib sos > threshold,
...
EOS=GetEOS_ver18(Ends, NDVI, bq, Time,bpy,SOS,bma) ; find last 20% point, get the possibx which is the nearest to the last 20% point, compare the possibx and the last 20%point,
